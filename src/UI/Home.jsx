...
export default function LandingPage() {
  ...
  return (
    <>
    <div className="min-h-screen flex flex-col container mx-auto items-center to-blue-200 py-10 pt-30 relative">
      <div className="max-w-5xl w-full rounded-2xl p-10 flex flex-col md:flex-row items-center mb-12">
        ...
        <motion.div
          ...
          viewport={{ once: false }} className="md:w-1/2 flex justify-center mt-8 md:mt-0">
          <img
            src={user?.avatar?.url}
